...
extension TexThemeExtensions on TextTheme {
  ...
  TextStyle get textButtomMedium => TextStyle(
  ...
  TextStyle get titleApBar => TextStyle(
        color: PlantaColors.colorWhite,
        fontWeight: FontWeight.bold,
        fontFamily: 'Nunito',
        letterSpacing: 1.5,
  ...
  TextStyle get textButtomLarge => TextStyle(
        color: PlantaColors.colorWhite,
        fontWeight: FontWeight.bold,
        fontFamily: 'Nunito',
        letterSpacing: 1.5,
  ...
  TextStyle get text_01 => TextStyle(
        color: PlantaColors.colorBlack,
        fontWeight: FontWeight.normal,
        fontStyle: FontStyle.normal,
        fontFamily: 'Nunito',
  ...
  TextStyle get text_02 => TextStyle(
        color: PlantaColors.colorBlack,
        fontWeight: FontWeight.normal,
        fontStyle: FontStyle.normal,
        fontFamily: 'Nunito',
  ...
  TextStyle get messengerScaffold => TextStyle(
        color: PlantaColors.colorWhite,
        fontWeight: FontWeight.normal,
        fontStyle: FontStyle.normal,
        fontFamily: 'Nunito',
