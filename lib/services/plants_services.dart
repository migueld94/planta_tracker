...
class OptionPlantServices {
  ...
  Future<DetailsEditPlant> getDetailsEdit(BuildContext context, int id) async {
    ...
    var response = await http.post(secretUrl, headers: <String, String>{
    ...
    final resp = await http.get(detailsEditUri,
  ...
  Future<http.Response?> updatePlant(RegisterPlant plant, String id) async {
    ...
    var updatePlantUri =
        Uri.parse('${Constants.baseUrl}/en/api/my_plants_update/');
