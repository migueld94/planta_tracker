...
class AuthService {
  var forgotPasswordUri = Uri.parse(
    '${Constants.baseUrl}/en/api/password_recover/',
  );
  var changePasswordUri = Uri.parse(
    '${Constants.baseUrl}/en/api/password_changed/',
  );
  ...
  var resendCodeUri = Uri.parse(
    '${Constants.baseUrl}/en/api/resend_activate_account_api',
  );
  ...
  Future<Response?> register({
    ...
    final Map<String, dynamic> data = json.decode(response.body);
    final accessToken = data["access_token"];
    var registerUri = Uri.parse('${Constants.baseUrl}/$lenguaje/api/users_api');
