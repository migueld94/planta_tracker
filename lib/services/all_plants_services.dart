...
class AllPlantServices {
  ...
  Future<List<Plant>> getAllPin(
    ...
    final allPinPlant = Uri.parse('${Constants.baseUrl}/es/api/plants_map_api');
  ...
  Future<List<Plant>> getSpeciesById(
    int id,
    double latMax,
    double latMin,
    double longMax,
    ...
    final speciesById = Uri.parse(
      '${Constants.baseUrl}/es/api/plants_map_api_filter',
    );
