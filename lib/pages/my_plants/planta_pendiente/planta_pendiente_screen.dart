...
class PlantasPendientesScreen extends StatefulWidget {
  final Function(bool) onLoadingChanged;
  const PlantasPendientesScreen({super.key, required this.onLoadingChanged});

  @override
  State<PlantasPendientesScreen> createState() =>
      _PlantasPendientesScreenState();
}

class _PlantasPendientesScreenState extends State<PlantasPendientesScreen> {
