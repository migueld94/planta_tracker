...
class _EditPlants06State extends State<EditPlants06> {
    ...
    if (await Permission.camera.isGranted &&
      ...
      setState(() {
        if (image != null) {
          ...
          widget.planta.images[5].posterPath = null;
          flag = true;
        } else {
        ...
        child: Center(
          child: Column(
            ...
            children: [
              if ((_image != null) ||
                  (widget.planta.images[5].posterPath != null) &&
                      (!widget.planta.images[5].posterPath!
                          .split('/')
                          .last
              ...
              verticalMargin57,
              if (widget.planta.images[5].posterPath == null ||
                  widget.planta.images[5].posterPath!
                      .split('/')
                      .last
                      .endsWith("De7au1t.png"))
                    ...
                    children: [
                      Container(
                        ...
                        child: ClipRRect(
                          borderRadius: borderRadius10,
                          child: Image.file(
                            File(widget.planta.images[5].posterPath!),
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
                ...
                : ButtomSkip(
                  ...
                  onTap: () async {
                    if ((_image != null) &&
                      ...
                      widget.valores.add({
                        "imagen": f.path,
                        "name": widget.planta.images[5].type,
                      });
            ...
            ButtomSmall(
              ...
              onTap: () async {
                if ((_image == null) &&
                  ...
                  widget.valores.add({
                    "imagen": widget.planta.images[5].posterPath,
                    "name":
                        AppLocalizations.of(
                          context,
  ...
  Color getColor() {
    if ((_image != null) && (widget.planta.images[5].posterPath == null)) {
